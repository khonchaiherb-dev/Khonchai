...
const CORE=['./','index.html','question-publication-manifest.json','question-content-integrity.json','source-verification-backlog.json','source-reverification-watchlist.json','styles.css?v=25','enhancements-v8.css?v=25','polish-v9.css?v=25','positions-v10.css?v=25','cosmic-v12.css?v=25','analytics-config.js?v=25','analytics-v13.js?v=25','base64-fix.js?v=25','app-v3.js?v=25','app-v3-part1.txt','app-v3-part2.txt','app-v3-part3.txt','app-v3-part4.txt','manifest.webmanifest?v=25'];
const BANK=[
