const CACHE='kexam-tax-v18';
const CORE=['./','index.html','styles.css?v=18','enhancements-v8.css?v=18','polish-v9.css?v=18','positions-v10.css?v=18','cosmic-v12.css?v=18','analytics-config.js?v=18','analytics-v13.js?v=18','base64-fix.js?v=18','app-v3.js?v=18','app-v3-part1.txt','app-v3-part2.txt','app-v3-part3.txt','app-v3-part4.txt','manifest.webmanifest?v=18'];
const BANK=[
