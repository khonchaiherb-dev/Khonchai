...
const withCanonicalMetadata=(response,env,pathname='')=>{
  ...
  return new HTMLRewriter().on('head',{element(head){
    ...
    head.append('<link rel="stylesheet" href="/tshop-v134-structural-storefront.css?v=1.34.6">',{html:true});
    ...
    head.append('<script defer src="/kch-v134-structural-storefront.js?v=1.34.6"></script>',{html:true});
