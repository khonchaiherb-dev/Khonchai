...
const STOREFRONT_ADDRESS_INTEGRITY='/storefront-v1-address-integrity.js?v=2026.09.05.1';
...
const STOREFRONT_CHECKOUT_ERROR_RECOVERY='/storefront-v1-checkout-error-recovery.js?v=2026.09.05.2';
...
const withCanonicalMetadata=(response,env,pathname='')=>{
  ...
  const rewriter=new HTMLRewriter().on('head',{element(head){
    ...
    if(home){
      ...
      head.append(`<script defer src="${STOREFRONT_ADDRESS_INTEGRITY}"></script>`,{html:true});
