const CACHE='khonchaiherb-v0.3.2';
const CORE=['/','/index.html','/styles.css','/v03.css','/v031.css','/app-core.js','/app-shop.js','/app-account.js','/app-admin-actions.js','/manifest.webmanifest'];
