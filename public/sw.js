const CACHE='khonchaiherb-v0.5.0';
const CORE=['/','/index.html','/styles.css','/v03.css','/v031.css','/tshop-v04.css','/tshop-v05.css','/app-core.js','/app-shop.js','/app-account.js','/app-admin-actions.js','/tshop-v04.js','/tshop-v05.js','/manifest.webmanifest'];
