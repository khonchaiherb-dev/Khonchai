const CACHE='khonchaiherb-v0.4.0';
const CORE=['/','/index.html','/styles.css','/v03.css','/v031.css','/tshop-v04.css','/app-core.js','/app-shop.js','/app-account.js','/app-admin-actions.js','/tshop-v04.js','/manifest.webmanifest'];
