...
function product(p){
  ...
  app.innerHTML=chrome(`<main class="tshop-pdp">
    ...
    <section class="pdp-block"><div class="shop-profile"><div class="shop-avatar">K</div><div class="shop-profile-copy"><b>KHONCHAIHERB Official</b><small>ร้านทางการ • ข้อมูลสินค้าและคำสั่งซื้อชัดเจน</small></div><button data-go="home">ดูร้าน</button></div><div class="shop-stats"><div><b>${PRODUCTS.length}</b><span>สินค้า</span></div><div><b>COD</b><span>เมื่อเข้าเงื่อนไข</span></div><div><b>ใบเสร็จ</b><span>หลังรับชำระ</span></div></div></section>
    <section class="pdp-block v07-review-shell"><div class="pdp-review-top"><b>คะแนนและรีวิวจากผู้ซื้อจริง</b><span>กำลังตรวจสอบ</span></div><div class="v07-review-loading">กำลังโหลดรีวิวที่ผ่านการยืนยันจากคำสั่งซื้อจริง…</div></section>
