...
assert.match(middleware,/kch-top-conversion\.js\?v=1\.31\.0/);
...
assert.match(js,/const BUILD='1\.31\.0'/);
...
console.log('storefront v1.31 top conversion + responsive + integrity smoke: OK');
