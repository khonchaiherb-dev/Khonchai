...
assert.match(source,/1\.7\.1/);assert.match(source,/data-v05-drawer-add/);assert.match(source,/v17Purchase/);assert.match(source,/stopImmediatePropagation/);assert.match(source,/pointerdown/);assert.match(source,/pointerType==='touch'/);assert.match(source,/isConnected===false/);
console.log('storefront interaction + direct touch/redraw-resilient product tap smoke: OK');
