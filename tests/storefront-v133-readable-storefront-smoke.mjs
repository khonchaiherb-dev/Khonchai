...
// v1.33 readability rules are retained as historical regression fixtures only.
// Production HTML must use the consolidated canonical v1.34.2 baseline instead.
...
console.log('storefront v1.33 historical readability fixture + v1.34.2 supersession smoke: OK');
