...
## Source Risk Model v2

การจัดลำดับ Source Verification Backlog ใช้ `source-risk-v2` และอ่านสัญญาณจากเนื้อหาของข้อสอบทั้งข้อ ได้แก่ หมวด โจทย์ ตัวเลือก คำอธิบาย และเหตุผลตัวเลือกผิด เพื่อไม่ให้กรณีที่อัตรา จำนวนเงิน กำหนดเวลา หรือมาตราปรากฏเฉพาะในตัวเลือกหลุดจากคิวความเสี่ยง

สัญญาณที่ใช้จัดลำดับครอบคลุม
- กฎหมาย มาตรา พระราชบัญญัติ พระราชกฤษฎีกา กฎกระทรวง ประกาศ และคำสั่ง
- อัตราภาษี ร้อยละ จำนวนเงิน วงเงิน ฐานภาษี เกณฑ์ และค่าลดหย่อน
- กำหนดเวลา วัน เดือน ปี และการนับระยะเวลา
- สิทธิ หน้าที่ โทษ เบี้ยปรับ เงินเพิ่ม การยกเว้น การจดทะเบียน การอุทธรณ์ และการคืนภาษี
- ข้อมูลที่อาจเปลี่ยนตามเวลา เช่น อัตราปัจจุบัน ปี พ.ศ. เงินเฟ้อ GDP ดอกเบี้ย และอัตราแลกเปลี่ยน
- ข้อคำนวณที่อิงอัตราหรือฐานภาษี

### เกณฑ์ลำดับคิว
- **เร่งด่วน**: risk score ตั้งแต่ 120 คะแนนขึ้นไป
- **สูง**: risk score 70–119 คะแนน
- **ปกติ**: risk score ต่ำกว่า 70 คะแนน

เกณฑ์ดังกล่าวเป็นเกณฑ์จัดลำดับงานตรวจ ไม่ใช่คำตัดสินว่าข้อสอบถูกหรือผิด

### Publication Gate
ข้อใหม่หรือข้อที่แก้ไขซึ่งมี risk score ตั้งแต่ 70 คะแนนขึ้นไปยังคงต้องผ่าน Source Verification ก่อนเปลี่ยนเป็น Published ดังนั้น Publication Gate 70 คะแนนกับเกณฑ์ “เร่งด่วน 120 คะแนน” มีหน้าที่ต่างกันและห้ามนำมาใช้แทนกัน

### Batch Selection
Source Review Batch เลือกคะแนนสูงก่อน แล้วจัดสัดส่วนตามตำแหน่งและหัวข้อภายในระดับคะแนนเดียวกัน เพื่อลดการกระจุกของข้อจากหัวข้อเดียว หน้า Admin ต้องใช้หลักเดียวกันในการ Preview Batch ถัดไป

ก่อนสร้าง Batch ระบบต้องยืนยันว่า backlog
- ใช้ `generation_mode = content-risk-ranked`
- ใช้ `risk_model = source-risk-v2`
- ใช้ threshold เร่งด่วน 120 และสูง 70
- เรียง risk score จากมากไปน้อย
- ไม่มี Question ID ซ้ำ
- ป้าย priority ตรงกับคะแนน
